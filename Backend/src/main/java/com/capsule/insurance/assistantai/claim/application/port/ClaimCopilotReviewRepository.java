...
public interface ClaimCopilotReviewRepository {
    ...
    ClaimCopilotReview registerDraft(Long claimId, ClaimCopilotReviewDraftSnapshot draft);

    Optional<ClaimCopilotReview> find(Long claimId, String requestId);

    Optional<ClaimCopilotReviewDraftSnapshot> findDraft(Long claimId, String requestId);
