...
const CATEGORIES = [
    ...
    { id: 'liability', label: '일상배상책임', subLabel: 'LIABILITY', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#F6CD3C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v18"></path><path d="M4 8h16"></path><path d="M4 8l3 6M20 8l-3 6"></path><path d="M4 14h6"></path><path d="M14 14h6"></path></svg>, bgColor: '#2A2514', fullWidth: true }
];
